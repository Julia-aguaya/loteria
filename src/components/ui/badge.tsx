...
const badgeVariants = cva('inline-flex max-w-full items-center rounded-full border px-2.5 py-1 text-center text-xs font-semibold whitespace-normal [overflow-wrap:anywhere]', {
  variants: {
    variant: {
